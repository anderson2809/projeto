                      ...
                      if (ops == 1 && a==0){
                        {
                          ...
                          if (senh == senha){
                                system("clear");
                                senha = 0;
                                printf("SENHA EXCLUÍDA COM SUCESSO (vá em 'Criar senha' e crie outra!\n\n");
                                a=0;
                            }
                          else if (senh != senha){
                                 system("clear");
